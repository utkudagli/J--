...
class JavaCCParser implements JavaCCParserConstants {
    ...
    try {
      ...
      classBody = classBody();
        ...
        {if (true) return new JClassDeclaration( line, mods,
            name, superClass, classBody, list );}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JInterfaceDeclaration InterfaceDeclaration(ArrayList<String>mods) throws ParseException {
    ...
    try {
      ...
      interfaceBody = interfaceBody();
        ...
        {if (true) return new JInterfaceDeclaration( line, mods, name, superClass, interfaceBody);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JStatement statement() throws ParseException {
    ...
    try {
      ...
      case FOR:
        ...
        forInit = statement();
        update = statement();
          statement = new JForStatement( line, forInit, test, body, update );
        break;
      case RETURN:
  ...
  final private JStatement forInit() throws ParseException {
    JStatement statement = null;
    ArrayList<JStatement> statementExpression = new ArrayList<JStatement>();
    boolean scannedFINAL = false;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case FALSE:
      ...
      case FLOAT_LITERAL:
        statement = statementExpression();
         statementExpression.add(statement);
        label_8:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
  ...
  final private JStatement update() throws ParseException {
    JStatement statement = null;
    ArrayList<JStatement> statementExpression = new ArrayList<JStatement>();
    try {
      statement = statementExpression();
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x400000,0x8000,0xb800480,0x0,0xb800080,0xb800080,0x1000,0x0,0x0,0x1000,0x0,0x8b820380,0x8b820380,0x80020300,0x0,0x20300,0x34326300,0x34306000,0x30302000,0x34306000,0x0,0x30302000,0x0,0x0,0x20300,0x0,0x0,0x30302000,0x0,0x30302000,0x0,0x30302000,0x20300,0x20300,0x0,0x0,0x20300,0x0,0x0,0x0,0x0,0x10000,0x10000,0x0,0x0,0x0,0x30302000,0x0,0x30302000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x30302000,0x20300,0x0,0x0,0x0,0x202000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x2000000,0x0,0x0,0x0,0x8,0x10,0x0,0x1000000,0x8000000,0x8000000,0x8000000,0x880000,0x8000000,0x888a6403,0x888a6403,0x88026400,0x888a6403,0x1000000,0x88026410,0x1000000,0x1000000,0x8000000,0x1000000,0x40,0x880a6400,0x1000000,0x880a6400,0x1000000,0x88026400,0x0,0x0,0x200000,0x200000,0x8000000,0x8040,0x8040,0x800,0x100,0x1200,0x1200,0x4020,0x4020,0x10000,0x88026400,0x2000,0x88020000,0x2200000,0x80,0x20000,0x2200000,0x20000,0x20000,0x2020000,0x20000,0x88020000,0x8000000,0x80000,0x20000,0x200000,0x80000000,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf,0xf,0xf,0xf,0x0,0xf,0x0,0x0,0x0,0x0,0x0,0xf,0x0,0xf,0x0,0xf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf,0x0,0xf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf,0x0,0x0,0x0,0x0,0xf,};
   }
