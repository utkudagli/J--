...
class JLorOp extends JBinaryExpression{
    public JLorOp(int line, JExpression lhs, JExpression rhs){
        super(line, "||", lhs, rhs);
    }
    public JExpression analyze(Context context){
        return this;
...
class JStarAssignOp extends JBinaryExpression{
...
class JDivAssignOp extends JBinaryExpression{
...
class JModAssignOp extends JBinaryExpression{
